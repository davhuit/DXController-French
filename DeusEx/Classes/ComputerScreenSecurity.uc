...
// ----------------------------------------------------------------------
// GamepadPan() — direct analog camera pan for the gamepad. dYaw / dPitch
...
// ----------------------------------------------------------------------
// GamepadZoom() — direct analog camera zoom for the gamepad. dFov is an
// fov-degree delta already integrated for the frame. Negative zooms in.
// Clamped to vanilla's [5, 90] fov limits.
// ----------------------------------------------------------------------

function GamepadZoom(float dFov)
{
	local float fov;
